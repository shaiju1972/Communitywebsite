...
function ProductGallery(props: Props) {
    ...
    const openPhotoswipe = (index: number) => {
        ...
        const items = imagesRefs.current.map((tag, index) => {
            ...
            return {
                src:`https://mc-file-storage.s3-ap-southeast-1.amazonaws.com/${images[index].url}`,
                msrc:`https://mc-file-storage.s3-ap-southeast-1.amazonaws.com/${images[index].url}`,
                w: width,
                h: height,
            };
        });
                    ...
                    {images.map((image, index) => (
                        ...
                        >
                            <div className="image__body">
                                <AppImage className="image__tag" src={`https://mc-file-storage.s3-ap-southeast-1.amazonaws.com/${images[index].url}`} />
                            </div>
                        </button>
                    ))}
                </AppSlick>

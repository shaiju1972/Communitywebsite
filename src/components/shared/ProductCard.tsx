        ...
        <div className={rootClasses} {...rootProps}>
            ...
            <div className="product-card__image">
                <div className="image image--type--product">
                    <AppLink href={url.propertiesDetails(product)} className="image__body">
                        {product.imageFiles.length > 0 && <AppImage className="image__tag" src={`https://mc-file-storage.s3-ap-southeast-1.amazonaws.com/${product.imageFiles[0].url}`} />}
                    </AppLink>
            </div>
            ...
            <div className="product-card__info">
                ...
                <div className="product-card__name">
                    ...
                    <AppLink href={url.propertiesDetails(product)}>{product.name}</AppLink>
                    <div className="product-card__rating">
                        <div className=" product-card__rating-label">
                            <FormattedMessage id="LABEL_AS" />{' '}
                             {product?.locationDetails?.locationName}</div>
                    </div>
                </div>
                ...
                {/* {!exclude.includes('features') && featuredAttributes.length > 0 && ( */}
                    <div className="product-card__features">
                        <ul>
                            ...
                            <li>
                                {product.noOfBathrooms} Bathrooms
                            </li>
                            <li>
                                {furnishedStatus[product.furnitureStatus]}
                            </li>
                        </ul>
                        {/* <ul>
                        ...
                        {!exclude.includes('list-buttons') && (
                            <React.Fragment>
                                {/* <AsyncAction
                                    action={() => cartAddItem(product)}
                                    render={({ run, loading }) => ( */}
                                    <AppLink href={url.propertiesDetails(product)}>
                                        <button
                                            type="button"
                                            className={classNames('product-card__addtocart-full')}
                                            // onClick={run}
                                        >
                                            <FormattedMessage id="BUTTON_VIEW_DETAILS" />
                                        </button>
                                    </AppLink>
                                    {/* )}
                                /> */}

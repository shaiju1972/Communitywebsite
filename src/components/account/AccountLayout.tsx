...
function AccountLayout(props: Props) {
    ...
    const navigation: ILink[] = [
        ...
        { title: intl.formatMessage({ id: 'TEXT_PROPERTIES'}), url: url.accountProperties() },
        { title: intl.formatMessage({ id: 'TEXT_VEHICLES'}), url: url.accountVehicles() },
        { title: intl.formatMessage({ id: 'TEXT_SERVICES' }), url: url.accountServices() },
        { title: intl.formatMessage({ id: 'TEXT_JOBS' }), url: url.accountJobs() },
        { title: intl.formatMessage({ id: 'TEXT_FEEDS' }), url: url.accountFeeds() },
        { title: intl.formatMessage({ id: 'HEADER_ORDER_HISTORY' }), url: url.accountOrderHistory() },

                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className={classNames('form-control', 'form-control-sm', {
                                'is-invalid': signInForm.errors.username,
                            })}
                        ...
                        <div className="invalid-feedback">
                            {signInForm.errors.username?.type === 'required' && (
                                <FormattedMessage id="ERROR_FORM_REQUIRED" />
                            )}
                            {/* {signInForm.errors.username?.type === 'email' && (
                ...
                <React.Fragment>
                    <AppLink href={url.accountDashboard()} className="account-menu__user" onClick={onCloseMenu}>
                        <div className="account-menu__user-avatar">
                            <AppImage src={user?.profilePic || '/images/default-avatar.png'} />
                        </div>
